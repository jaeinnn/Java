...
/*
 앞의 예제를 참고하여 "Kill Timer"문자열을 가진 버튼을 하나 추가적으로 만든다.
 이 버튼을 선택하면 타이머 스레드에게 InterruptException을 보내 
 타이머스레드를 강제종료시킨다. 동시에 버튼을 비활성화시킨다 
 */
